...
class Informacion extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<Widget> reviewCards = [
      const Reviewcard(
        avatarUrl: 'assets/images/astrid.png', // URL de avatar o imagen
        name: 'Astrid Serrato',
        date: '2023-06-12',
      ...
      const Reviewcard(
        avatarUrl: 'assets/images/paulina.png',
        name: 'Paulina Flores',
        date: '2023-06-12',
      ...
      const Reviewcard(
        avatarUrl: 'assets/images/tane.png',
        name: 'Tane Cruz',
        date: '2023-06-12',
      ...
      const Reviewcard(
        avatarUrl: 'assets/images/pedro.png',
        name: 'Pedro Cerna',
        date: '2023-06-12',
      ...
      const Reviewcard(
        avatarUrl: 'assets/images/gumer.png',
      ...
      const Reviewcard(
        avatarUrl: 'assets/images/brandon.png',
        name: 'brandon jacobo',
        date: '2023-06-12',
      ...
      const Reviewcard(
        avatarUrl: 'assets/images/alejandro.png',
      ...
      const Reviewcard(
        avatarUrl: 'assets/images/ernesto.png',
        name: 'Ernesto Leon',
        date: '2023-06-12',
      ...
      const Reviewcard(
        avatarUrl: 'assets/images/christian.png',
      ...
      const Reviewcard(
        avatarUrl: 'assets/images/luz.png',
        name: 'luz salazar',
        date: '2023-06-12',
